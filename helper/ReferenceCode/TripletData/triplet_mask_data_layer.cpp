...
#include "caffe/layers/triplet_mask_data_layer.hpp"
...
TripletMaskDataLayer<Dtype>::~TripletMaskDataLayer<Dtype>() {
  this->StopInternalThread();
}

template <typename Dtype>
void TripletMaskDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void TripletMaskDataLayer<Dtype>::ShuffleTriplets() {
...
template <typename Dtype>
void TripletMaskDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(TripletMaskDataLayer);
